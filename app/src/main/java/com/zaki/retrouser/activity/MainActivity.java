...
public class MainActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        progress=ProgressDialog.show(this,"Loading","Fetching User List",true);
        ...
        btnFetchPost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tvId.getText().toString().equals(Constant.USER_CURRENT_ID)){
                    Toast.makeText(MainActivity.this,"Please Click a User Above",Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void recyclerTouchHandle(){
        userAdapter.setOnClickListener(new UserAdapter.UserClickListener() {
            ...
            public void onCLick(int position) {
                ...
                setData(user.getUserName(),String.valueOf(user.getUserId()));
            }
        });
    }
     ...
     * @param id as User Id
     */
    private void setData(String name,String id){
        tvId.setText(id);
        tvName.setText(name);
    }
}
